...
import { CreateSeriesDto, CreateSeriesSchema, GetSeriesDto, GetSeriesSchema, SeriesCommandService, SeriesQueryService, UpdateSeriesDto, UpdateSeriesSchema } from 'src/modules/series';
