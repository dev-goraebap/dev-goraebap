...
export class AdminCuratedItemsController {
  ...
  constructor(
    ...
    private readonly curatedItemsCommandService: CuratedItemsCommandService
  ) { }
  ...
  async destroy(
    ...
    await this.curatedItemsCommandService.destroyItem(id);
  ...
  async cleanupOldItems(
    ...
    const deletedCount = await this.curatedItemsCommandService.cleanupOldItems(days);
