...
import { GetAdminPostsDto, GetAdminPostsSchema, PostQueryService } from '../../use-cases';
import { CreatePostDto, CreatePostSchema } from '../../use-cases/dto/create-or-update-post.dto';
import { PostApplicationService } from '../../use-cases/post-application.service';
...
export class AdminPostController {
  ...
  async index(@Req() req: NestMvcReq, @Query() dto: GetAdminPostsDto) {
    const postData = await this.postQueryService.getAdminPostsWithPagination(dto);
  ...
  @Delete(':id')
  destroy(@Param('id') id: number, @Req() req: NestMvcReq, @Res() res: Response) {
