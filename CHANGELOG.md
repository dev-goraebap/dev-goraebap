...
### 수정됨
  - prismjs를 동적 로드에서 -> 사전로드로 변경
  
    prismjs를 사용하지 않는 페이지에서도 불러오는 비용을 줄이려고 했으나, 페이지의 테마 변경 등의 기능에서 느리게 작동 또는, 간혹 로드되지 않는 문제 해결 하기위함
  - 시리즈 내 컨텐츠 조회도 syntax-highlighter 적용

## [1.0.5] - 2025-10-14

### 수정됨
  - 시리즈 내부 이미지 그림자 효과 제거. 아스키아트 틀어짐 수정

## [1.0.4] - 2025-10-13

### 변경됨
  - 시리즈 컨텐츠에서 이전포스트, 다음포스트 순서 변경 및 로직 수정
